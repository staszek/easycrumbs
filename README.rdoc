...
You can write new class inherited from EasyCrumbs::Collection or just monkey patch initialize method from EasyCrumbs::Collection
...
For objects:
  grandfather = Person.new, :breadcrumb => "Grandfather"
  father = Person.new :parent => grandfather, :breadcrumb => "Father"
  son = Person.new :parent => father, :breadcrumb => "Son"
